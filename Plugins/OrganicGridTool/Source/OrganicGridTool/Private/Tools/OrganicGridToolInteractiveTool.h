...
#include "OrganicGridToolInteractiveTool.generated.h"


/**
 * Builder for UOrganicGridToolInteractiveTool
 */
UCLASS()
class ORGANICGRIDTOOL_API UOrganicGridToolInteractiveToolBuilder : public UInteractiveToolBuilder
{
	GENERATED_BODY()
...
/**
 * Property set for the UOrganicGridToolInteractiveTool
 */
UCLASS(Transient)
class ORGANICGRIDTOOL_API UOrganicGridToolInteractiveToolProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()

public:
	UOrganicGridToolInteractiveToolProperties();
...
/**
 * UOrganicGridToolInteractiveTool is an example Tool that allows the user to measure the 
 ...
 */
UCLASS()
class ORGANICGRIDTOOL_API UOrganicGridToolInteractiveTool : public UInteractiveTool, public IClickDragBehaviorTarget
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY()
	TObjectPtr<UOrganicGridToolInteractiveToolProperties> Properties;
