...
#include "OrganicGridToolInteractiveTool.h"
...
#define LOCTEXT_NAMESPACE "UOrganicGridToolInteractiveTool"
...
///-///////////////////////////////////////////////////////////////////////////////////////////
///
UInteractiveTool* UOrganicGridToolInteractiveToolBuilder::BuildTool(const FToolBuilderState & SceneState) const
{
	UOrganicGridToolInteractiveTool* NewTool = NewObject<UOrganicGridToolInteractiveTool>(SceneState.ToolManager);
...
///-///////////////////////////////////////////////////////////////////////////////////////////
///
UOrganicGridToolInteractiveToolProperties::UOrganicGridToolInteractiveToolProperties()
{
...
///-///////////////////////////////////////////////////////////////////////////////////////////
///
void UOrganicGridToolInteractiveTool::SetWorld(UWorld* World)
{
	check(World);
...
///-///////////////////////////////////////////////////////////////////////////////////////////
///
void UOrganicGridToolInteractiveTool::Setup()
{
	...
	Properties = NewObject<UOrganicGridToolInteractiveToolProperties>(this, "Measurement");
...
///-///////////////////////////////////////////////////////////////////////////////////////////
///
void UOrganicGridToolInteractiveTool::OnUpdateModifierState(int ModifierID, bool bIsOn)
{
...
///-///////////////////////////////////////////////////////////////////////////////////////////
///
FInputRayHit UOrganicGridToolInteractiveTool::CanBeginClickDragSequence(const FInputDeviceRay& PressPos)
{
...
///-///////////////////////////////////////////////////////////////////////////////////////////
///
void UOrganicGridToolInteractiveTool::OnClickPress(const FInputDeviceRay& PressPos)
{
...
///-///////////////////////////////////////////////////////////////////////////////////////////
///
void UOrganicGridToolInteractiveTool::OnClickDrag(const FInputDeviceRay& DragPos)
{
	UpdatePosition(DragPos.WorldRay);
}


FInputRayHit UOrganicGridToolInteractiveTool::FindRayHit(const FRay& WorldRay, FVector& HitPos)
{
...
void UOrganicGridToolInteractiveTool::UpdatePosition(const FRay& WorldRay)
{
...
void UOrganicGridToolInteractiveTool::UpdateDistance()
{
	Properties->Distance = FVector::Distance(Properties->StartPoint, Properties->EndPoint);
}


void UOrganicGridToolInteractiveTool::OnPropertyModified(UObject* PropertySet, FProperty* Property)
{
...
void UOrganicGridToolInteractiveTool::Render(IToolsContextRenderAPI* RenderAPI)
{
