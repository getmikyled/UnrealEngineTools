 ...
 */
UCLASS()
class UOrganicGridToolEditorMode : public UEdMode
{
	GENERATED_BODY()

public:
	const static FEditorModeID EM_OrganicGridToolEditorModeId;

	static FString SimpleToolName;
	static FString InteractiveToolName;

	UOrganicGridToolEditorMode();
	virtual ~UOrganicGridToolEditorMode();
